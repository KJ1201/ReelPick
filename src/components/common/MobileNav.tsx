...
export function MobileNav() {
    ...
    return (
        <div className="md:hidden fixed bottom-6 left-1/2 -translate-x-1/2 flex items-center justify-between px-2 h-[64px] bg-ink-90/85 backdrop-blur-2xl border border-white/10 rounded-full shadow-[0_8px_32px_rgba(0,0,0,0.60)] z-[200] w-[92%] max-w-[400px]">
            {navItems.map((item) => {
